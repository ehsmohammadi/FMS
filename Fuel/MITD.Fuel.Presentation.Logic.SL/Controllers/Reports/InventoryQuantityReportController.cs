...
{
    public class InventoryQuantityReportController : BaseController, IInventoryQuantityReportController
    {

        public InventoryQuantityReportController(IViewManager _viewManager, IEventPublisher eventPublisher, IDeploymentManagement deploymentManagement)
        ...
        private void showReportWindow(string type)
        {
            ...
            var reportViewerPageUri = new Uri(hostingSiteBaseAddress + "/Reports/ReportViewer.aspx?ItemPath=InventoryQuantityReport&Type=" + type, UriKind.Absolute);
