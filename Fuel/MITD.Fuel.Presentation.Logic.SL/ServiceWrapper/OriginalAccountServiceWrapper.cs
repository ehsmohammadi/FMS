...
{
    public class OriginalAccountServiceWrapper : IOriginalAccountServiceWrapper
    {

        private string hostAccountAddressController;
        public OriginalAccountServiceWrapper()
        {
            hostAccountAddressController = ApiConfig.HostAddress + "apiarea/Fuel/OriginalAccount/{0}";
        }
