...
{
    public class HafezFinancialVoucherService
    {
        private IVoucherRepository _voucherRepository;
        private IUnitOfWorkScope _unitOfWorkScope;

        public HafezFinancialVoucherService(IVoucherRepository voucherRepository, IUnitOfWorkScope unitOfWorkScope)
        {
                ...
                using (var trans = new TransactionScope())
                {
                    ...
                    vouchers.ForEach(v =>
                    {
                        ...
                        v.JournalEntrieses.ForEach(j =>
                        {
                            ...
                            article.purposeID = ++i;
                            article.reference = j.VoucherRef;
                            //article.tag
                            Articls.Add(article);
                        });
                    });
