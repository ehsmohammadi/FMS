...
{
   public class AddCharterInStartIssueDiffVoucher : IAddCharterInStartIssueDiffVoucher
    {
        #region Prop
        ...
        public AddCharterInStartIssueDiffVoucher(IVoucherRepository voucherRepository,
        ...
        public void Execute(CharterIn charterIn, List<Issue> issues, string issueWarehouseCode, string issueNumber, long userId, string lineCode, string voyageCode)
        {
            try
            {
                ...
                issues.ForEach(c =>
                {
                    ...
                    var debiJournalEntry = CreateDebitJournalEntry(c, voucherSeting, charterIn, lineCode, voyageCode);
                    voucher.JournalEntrieses.Add(debiJournalEntry);

                    var creditJournalEntry = CreateCreditJournalEntry(c, voucherSeting, issueWarehouseCode, charterIn.VesselInCompany.Vessel.Code, lineCode, voyageCode);
        ...
        VoucherSeting GetVoucherSeting(CharterIn charterIn)
        {
            var voucherSetingHeader =
                _voucherSetingRepository.Find(c => c.VoucherDetailTypeId == VoucherDetailType.CharterInStartVariance.Id
